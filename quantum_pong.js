...
var ASM_CONSTS = {
  101624: () => { if (document.fullscreenElement) return 1; },  
 101670: () => { return document.getElementById('canvas').width; },  
 101722: () => { return parseInt(document.getElementById('canvas').style.width); },  
 101790: () => { document.exitFullscreen(); },  
 101817: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 101890: () => { if (document.fullscreenElement) return 1; },  
 101936: () => { return document.getElementById('canvas').width; },  
 101988: () => { return screen.width; },  
 102013: () => { document.exitFullscreen(); },  
 102040: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 102173: () => { return window.innerWidth; },  
 102199: () => { return window.innerHeight; },  
 102226: () => { if (document.fullscreenElement) return 1; },  
 102272: () => { return document.getElementById('canvas').width; },  
 102324: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102392: () => { if (document.fullscreenElement) return 1; },  
 102438: () => { return document.getElementById('canvas').width; },  
 102490: () => { return screen.width; },  
 102515: () => { return window.innerWidth; },  
 102541: () => { return window.innerHeight; },  
 102568: () => { if (document.fullscreenElement) return 1; },  
 102614: () => { return document.getElementById('canvas').width; },  
 102666: () => { return screen.width; },  
 102691: () => { document.exitFullscreen(); },  
 102718: () => { if (document.fullscreenElement) return 1; },  
 102764: () => { return document.getElementById('canvas').width; },  
 102816: () => { return parseInt(document.getElementById('canvas').style.width); },  
 102884: () => { document.exitFullscreen(); },  
 102911: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 102969: () => { return screen.width; },  
 102994: () => { return screen.height; },  
 103020: () => { return window.screenX; },  
 103047: () => { return window.screenY; },  
 103074: () => { return window.devicePixelRatio; },  
 103110: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 103163: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 103234: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 103291: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 103547: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 103618: () => { if (document.fullscreenElement) return 1; },  
 103664: () => { return window.innerWidth; },  
 103690: () => { return window.innerHeight; },  
 103717: () => { if (document.pointerLockElement) return 1; }
};
